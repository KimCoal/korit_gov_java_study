...
* 타입 매개변수
* 클래스나 메소드에서 사용할 실제 타입을 태신해서 사용하는 매개변수
...
*
* 타입 안정성
* 컴파일 시 타입 체크가 가능하며, 잘못된 타입이 들어갈 수 없음
* 컴파일 시점에 타입 체크를 할 수 있어 프로그램의 안정성을 높이고, 명시적이 형변환(casting)을 줄인다
*
* */