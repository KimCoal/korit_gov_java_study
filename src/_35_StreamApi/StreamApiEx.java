...
public class StreamApiEx {
    public static void main(String[] args) {
        ...
        if (input.equalsIgnoreCase("samsung")) input = "삼성";
        if (input.equalsIgnoreCase("lg")) input = "엘지";

        String key = input;

        List<String> searchProductList = products.stream()
                .filter(n -> n.contains(key))
                .toList();

        System.out.println(key + "브랜드 상품 목록");
